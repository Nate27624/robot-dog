...
## Server
Does the data processing.  Recieved data from the controller, processes the data and communicates back to the controller on a corrsponding output to perform with that data
